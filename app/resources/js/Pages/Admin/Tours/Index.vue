      ...
      <table class="min-w-full">
        ...
        <tbody class="divide-y divide-gray-50">
          <tr v-for="tour in tours.data" :key="tour.id" class="transition hover:bg-gray-50/50">
            ...
            <td class="px-5 py-3.5">
              <span v-if="tour.project" class="inline-flex rounded-full bg-[#003274]/5 px-2.5 py-1 text-xs font-medium text-[#003274]">{{ projectLabel(tour.project) }}</span>
            ...
            <td class="px-5 py-3.5 text-right">
              <div class="flex items-center justify-end gap-2">
                ...
                <button @click="confirmDestroy(tour)" class="rounded-lg p-2 text-gray-400 transition hover:bg-red-50 hover:text-red-600">
