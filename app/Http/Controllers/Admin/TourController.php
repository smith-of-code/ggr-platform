...
class TourController extends Controller
{
    ...
    private function validateTour(Request $request): array
    {
        return $request->validate([
            ...
            'program_pdf' => 'nullable|string|max:500',
            'program_days' => 'nullable|array',
            'program_days.*.title' => 'required|string|max:255',
            'program_days.*.description' => 'nullable|string',
            'memo_pdf' => 'nullable|string|max:500',
            'memo_text' => 'nullable|string',
            'pass_info' => 'nullable|string',
            'departure_info' => 'nullable|string',
            'accommodation_info' => 'nullable|string',
            'accommodations' => 'nullable|array',
            'accommodations.*.title' => 'required|string|max:255',
            'accommodations.*.budget' => 'nullable|string|in:economy,standard,comfort,luxury',
            'accommodations.*.description' => 'nullable|string',
            'accommodations.*.images' => 'nullable|array',
            'accommodations.*.images.*' => 'string',
            'departure_text_blocks' => 'nullable|array',
            'departure_text_blocks.*.title' => 'required|string|max:255',
            'departure_text_blocks.*.subtitle' => 'nullable|string|max:500',
            'departure_text_blocks.*.position' => 'nullable|integer|min:0',
