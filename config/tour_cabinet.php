...
return [
    ...
    */
    ...
    /*
    |--------------------------------------------------------------------------
    | Блок «Твой билет в атомный город» (Разделение) на дашборде ЛК туров
    |--------------------------------------------------------------------------
    |
    | Расположен между блоком «Стандартная анкета» и блоком «Конкурс». Две
    | карточки — «Победить в конкурсе» (бесплатно) и «За свой счёт». Кнопки
    | прокручивают и подсвечивают целевые секции дашборда (#tour-cabinet-
    | contest-detail и #tour-cabinet-commerce-tours), без ухода со страницы.
    |
    | Все тексты редактируются администратором: /admin/tour-cabinet → блок
    | «Разделение». Значения сохраняются в settings (группа tour_cabinet,
    | ключ atomic_ticket_block, JSON-строка) и имеют приоритет над этими
    | дефолтами. target_anchor у карточек захардкожен — в админке не правится.
    |
    */
    'atomic_ticket_block' => [
        'enabled' => filter_var(
            env('TOUR_CABINET_ATOMIC_TICKET_ENABLED', true),
            FILTER_VALIDATE_BOOLEAN
        ),
        'title' => env('TOUR_CABINET_ATOMIC_TICKET_TITLE', 'Твой билет в атомный город'),
        'free' => [
            'title' => 'Победить в конкурсе',
            'cta_label' => 'Участвовать в конкурсе',
            'steps' => [
                [
                    'title' => 'Зарегистрируйтесь на конкурс',
                    'description' => 'Создайте личный кабинет и заполните анкету участника.',
                ],
                [
                    'title' => 'Пройдите этапы конкурса',
                    'description' => 'Заполните анкету по выбранному городу, ответьте на вопросы и выполните проверочное задание.',
                ],
                [
                    'title' => 'Получите путёвку',
                    'description' => 'Победители отправляются в тур по приглашению — за счёт программы.',
                ],
            ],
        ],
        'paid' => [
            ...
            'steps' => [
                [
                    'title' => 'Выберите город и тур',
                    'description' => 'В блоке «Коммерческие туры» укажите интересующий вас город и подходящий тур.',
                ],
                [
                    'title' => 'Заполните анкету',
                    'description' => 'Дополнительные данные нужны менеджеру, чтобы оперативно связаться с вами.',
                ],
                [
                    'title' => 'Дождитесь обратной связи',
                    'description' => 'Менеджер программы свяжется с вами и расскажет о деталях.',
                ],
            ],
        ],
    ],
