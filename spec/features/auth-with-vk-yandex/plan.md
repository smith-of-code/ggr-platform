...
1. **Инфраструктура** — установка `laravel/socialite` + `socialiteproviders/yandex` + кастомный `App\Socialite\VkIdProvider` для VK ID API (`id.vk.ru`, PKCE S256), конфигурация `config/services.php`, env-переменные
