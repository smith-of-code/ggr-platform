...
- Для всех полей с изображениями, где сейчас используется только URL, добавить возможность выбрать существующее фото из медиатеки или загрузить новое фото из админ-формы.
...
## Правки заказчика (2026-04-28)

- **[NEW_REQUIREMENT]** Добавить возможность выбрать или загрузить фото везде, где в редакторе главной страницы для изображения сейчас предусмотрен только URL.
- Обновление расширяет текущий scope: вместо URL-only сценария редактор должен поддерживать оба пути (вставка URL и выбор/загрузка файла).
