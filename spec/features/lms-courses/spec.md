...
1. **Админка (StageEditor.vue)**: при создании/редактировании этапа отображается список блоков. Каждый блок имеет тип и контент. Кнопка «Добавить блок» создаёт новый блок.
...
4. **Прохождение этапа**: last_completed_at → mark complete (контент/видео) или автозавершение (тест/задание)
