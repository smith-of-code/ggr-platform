<template>
  <AdminLayout>
    ...
    >
      <div v-if="form.target_audience" class="mb-6 rounded-xl bg-amber-50 p-4">
        <p class="mb-1 text-xs font-semibold uppercase tracking-wider text-amber-600">Целевая аудитория</p>
        <p class="text-sm text-amber-900">{{ form.target_audience }}</p>
      </div>
    </ContentPreview>
  </AdminLayout>
</template>
